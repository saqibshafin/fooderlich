...
class AppLink {
  ...
  static AppLink fromLocation(String? location) {
    ...
    // Parse the URI for location, query parameter keys and key-value pairs.
    ...
    // Create the AppLink by passing in the query parameters you extracted from
    //the URL string.
    final link = AppLink(
      location: uri.path,
  ...
  // The app will also need the converse transformation, from AppLink to simple
  //string.
  // Add toLocation:
  // This converts AppLink back to a URI string.
  String toLocation() {
    //?? where's the return string for toLocation()?
    //
