...
class GroceryItemScreen extends StatefulWidget {
  ...
  // late GroceryManager _groceryManager;
  // _groceryManager.groceryItemTapped(-1); // = -1;
  ...
  //   onCreate when the user finishes creating the new item.
  //   onUpdate when the user finishes updating an item.
...
*/
      child: Scaffold(
          ...
          actions: [
            IconButton(
              ...
              onPressed: () {
                ...
                // add or update the current grocery item
        ...
        //       .groceryItemTapped(-1);
        //   return false; // i should return false, not true.
        //   // return true;
        // },
        // ),
      ),
      onWillPop: () async {
        Provider.of<GroceryManager>(context, listen: false)
            .groceryItemTapped(-1);
        return false; // i should return false, not true.
        // we used 'false' to prevent the error "No element", which is caused by
        //popping the current view/widget, by returning 'true'.
        //return true;
      },
    );
  }
